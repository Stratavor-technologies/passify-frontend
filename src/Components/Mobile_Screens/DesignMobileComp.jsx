...
import qr_A from "../../assets/images/qr_A.png";
import andriodImg from  "../../assets/images/andriod-img.jpg";
import base_logo from "../../assets/images/base_logo.png";
import { IoCloseSharp } from "react-icons/io5";
import { HiDotsVertical } from "react-icons/hi";

const DesignMobileComp = ({ mobileViewData, id, setNodeElement , currentDevice="apple", businessName}) => {
  ...
  const logoImage = mobileViewData?.logo_image;
  ...
  return (
    <>
      ...
      <div
        className="flex flex-col justify-between py-2 m-[1rem] rounded-[.625rem]"
        style={cardBackgroundColor}
      >
        <div className="flex flex-col">
            <div className="flex justify-between items-center px-2 pb-3 h-[3.4375rem]">
              {mobileViewData && mobileViewData.logo_image ? (
                <div className="relative w-[3.3125rem] h-[3.3125rem]">
                  <img
                    src={
                      (logoImage?.name && !id) || (logoImage?.name && id)
                        ? URL.createObjectURL(logoImage)
                        : defaultImageConfig.Base_URL + logoImage
                    }
                    alt=""
          ...
          {currentDevice === "android" && (
                  ...
                  <div class="andriod-box">
                    ...
                    <div className="px-4 py-4">
                      <div style={cardTextColor} class="uppercase font-normal text-sm">Stamp</div>
...
export default DesignMobileComp;
